...
void CreateCharacter(Player& thePlayer)
{
	...
	std::cout << "01) Dwarf" << std::endl;
	std::cout << "02) Elf" << std::endl;
	std::cout << "03) Halfling" << std::endl;
	std::cout << "04) Human" << std::endl;
	std::cout << "05) Dragonborn" << std::endl;
	std::cout << "06) Gnome" << std::endl;
	std::cout << "07) Half-Elf" << std::endl;
	std::cout << "08) Half-Orc" << std::endl;
	std::cout << "09) Tiefling" << std::endl;	
	std::cout << "Please enter the # of your choice (1 to 9): ";
	int raceChoice;
	std::cin >> raceChoice;
	...
	//choose your class
	std::cout << "What class do you wish to play as?" << std::endl;	
	std::cout << "01) Barbarian" << std::endl;
	std::cout << "02) Bard" << std::endl;
	std::cout << "03) Cleric" << std::endl; 
	std::cout << "04) Druid" << std::endl;
	std::cout << "05) Fighter" << std::endl;
	std::cout << "06) Monk" << std::endl;
	std::cout << "07) Paladin" << std::endl;
	std::cout << "08) Ranger" << std::endl;
	std::cout << "09) Rogue" << std::endl;
	std::cout << "10) Sorcerer" << std::endl;
	std::cout << "11) Warlock" << std::endl;
	std::cout << "12) Wizard" << std::endl;
	std::cout << "Please enter the # of your choice (1 to 12): ";
	int classChoice;
	std::cin >> classChoice;
